...
class MetaLearner(object):
    ...
    def sample(self, tasks, predators, first_order=False, iteration=None):
        ...
        for task in tasks:
            ...
            train_episodes = self.sampler.sample(
                policy=self.policy, params=None, predators=predators,
            ...
            valid_episodes = self.sampler.sample(
                self.policy, params=params, predators=predators,
                gamma=self.gamma, device=self.device)
